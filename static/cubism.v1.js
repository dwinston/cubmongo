...
cubism.context = function() {
  ...
  context.start = function() {
    ...
    if (delay < clientDelay) delay += advance;
    ...
    timeout = setTimeout(function prepare() {
      ...
      timeout = setTimeout(prepare, advance);
    }, delay);
    return context;
  };
  ...
  // Set or get the advance interval in milliseconds.
  // Defaults to ten seconds.
  context.advance = function(_) {
    if (!arguments.length) return advance;
    advance = +_;
    return update();
  };
